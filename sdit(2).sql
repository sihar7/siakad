...
--
-- Host: localhost
-- Generation Time: Feb 10, 2024 at 12:04 PM
...
CREATE TABLE `students` (
  ...
  `nm_lengkap_ayah` varchar(50) NOT NULL,
  `nm_lengkap_ibu` varchar(50) NOT NULL,
  `no_telp` varchar(20) NOT NULL,
  `pekerjaan_ayah` varchar(30) NOT NULL,
  `pekerjaan_ibu` varchar(30) NOT NULL,
  `pddk_ayah` varchar(30) NOT NULL,
  `pddk_ibu` varchar(30) NOT NULL,
  `asal_tk` varchar(30) NOT NULL,
  `alamat_tk` varchar(30) NOT NULL,
