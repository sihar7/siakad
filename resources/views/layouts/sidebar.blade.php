<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      style="opacity: .8"> --}}
        <span class="brand-text font-weight-light">SDIT At-Tajdied</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          with font-awesome or any other icon font library -->
                ...
                @if (auth()->user()->role == 'admin')
                    ...
                    <li class="nav-item">
                        <a href="/calon_siswa" class="nav-link {{ Request::is('calon_siswa*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="/class-students"
                            class="nav-link {{ Request::is('class-students*') ? 'active' : '' }}">
                ...
                @elseif(auth()->user()->role == 'petugas')
                    ...
                    <li class="nav-item">
                        <a href="/admin" class="nav-link {{ Request::is('student/profile') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-user"></i>
                            <p>Profil</p>
                        </a>
                    </li>
